...
| `KILLED_BY_SHRINK` | notify `PMIX_ERR_PROC_KILLED_BY_CMD` + recover | set `KILLED_BY_SHRINK`; force `PRTE_ERROR_DEFAULT_EXIT_CODE` when the killed proc reported none; `_terminate_job` |
