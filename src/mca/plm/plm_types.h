...
#define PRTE_PROC_STATE_KILLED_BY_SHRINK        (PRTE_PROC_STATE_ERROR + 19) /* a DVM shrink released the node the process ran on */
...
#define PRTE_JOB_STATE_KILLED_BY_SHRINK         (PRTE_JOB_STATE_ERROR + 22) /* a DVM shrink killed at least one of this job's procs */
