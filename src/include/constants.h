...
enum {
    ...
    PRTE_ERR_SLURM_SUBMIT_FAILURE = (PRTE_ERR_SPLIT - 54),
    PRTE_ERR_SLURM_CANCEL_FAILURE = (PRTE_ERR_SPLIT - 55),
    PRTE_ERR_SLURM_SHRINK_FAILURE = (PRTE_ERR_SPLIT - 56),
    PRTE_ERR_SLURM_BAD_JOB_STATUS = (PRTE_ERR_SPLIT - 57)
};
